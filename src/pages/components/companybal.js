      ...
      <Card.Body>
        ...
        <Row>
          ...
          <Row>
            <Col md={6} className="mb-3">
              <Form.Group id="firstName">
                <Form.Label> Player Capacity</Form.Label>
                <br/>
                <button>Player Capacity</button>
              </Form.Group>
            </Col>
        ...
        <table className="table">
          <thead className="thead-light">
            <tr>
              ...
              <th style={{border:"1px double black",width:"30px",backgroundColor:"00ADB5",color:"black",textAlign:"center"}}>Players Capacity</th>
