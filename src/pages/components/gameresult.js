...
export default class buttons extends Component {
  ...
  render()
 {
    ...
    return (
      ...
      <Card.Body>
        <h5 className="mb-4">Game Result </h5>
      ...
      {/* <div className="table-settings mb-4">
        ...
        <div className="d-block mb-4 mb-md-0">
          <Breadcrumb className="d-none d-md-inline-block" listProps={{ className: "breadcrumb-dark breadcrumb-transparent" }}>
            ...
            <Breadcrumb.Item>Game Results</Breadcrumb.Item>
        ...
        <table className="table">
          <thead className="thead-light">
            <tr>
              ...
              <th style={{border:"1px double black",width:"150px",backgroundColor:"00ADB5",color:"black",textAlign:"center"}}>Status</th>
             
              <th style={{border:"1px double black",width:"30px",backgroundColor:"00ADB5",color:"black",textAlign:"center"}}>Result</th>
