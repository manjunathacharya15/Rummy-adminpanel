...
export default class Accordion extends Component{
      ...
      deleteCustomerByIds = () => {
        ...
        onChangeimage(e) {
          ...
          onSubmit(e) {
            ...
            axios.post('https://arummynodejs.herokuapp.com/mobileslider/add', formData)
            .then(function(response){
        
              if(response.data ==='Mobileslider added!'){
                alert(" Mobile Slider Added")
                window.location.reload(true)
              }
             }) 
          }
    ...
    render(){
      ...
      <Card.Body>
        <h5 className="mb-4">Add Mobile Slider</h5>
