    ...
    return (
      ...
      <Card.Body>
        ...
        <Row className="justify-content-between align-items-center">
          ...
          <Link to={"/components/newsms"}>  <Button>Add Sms</Button></Link>
          </Col>
      ...
      <div className="table-settings mb-4">
        ...
        <div className="d-block mb-4 mb-md-0">
          <Breadcrumb className="d-none d-md-inline-block" listProps={{ className: "breadcrumb-dark breadcrumb-transparent" }}>
            ...
            <Breadcrumb.Item>Player Sms List</Breadcrumb.Item>
        ...
        <table className="table">
          <thead className="thead-light">
            <tr>
              ...
              <th style={{border:"1px double black",width:"150px",backgroundColor:"00ADB5",color:"black",textAlign:"center"}}>Username</th>
              ...
              <th style={{border:"1px double black",width:"30px",backgroundColor:"00ADB5",color:"black",textAlign:"center"}}>Response </th>
